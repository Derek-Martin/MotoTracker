 ...
 * {@link TagEditFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link TagEditFragment#newInstance} factory method to
...
public class TagEditFragment extends Fragment {
    ...
    public static TagEditFragment newInstance(String param1) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            reference = FirebaseDatabase.getInstance().getReference(getArguments().getString(ARG_PARAM1));
        }
    }
